                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            widget.dObj['images'] != null &&
                                    ...
                                    widget.dObj['images'][0]['image'] != null
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              var nObj =
                                  widget.dObj['ingredient'][index] as Map? ??
                                      {};
                              return Container(
                                  margin:
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: ((context, index) {
                          ...
                          return FoodStepDetailRow(
                            ...
                            isLast: index == widget.dObj['steps'].length - 1,
                          );
                        }),
                      ),
                      SizedBox(
